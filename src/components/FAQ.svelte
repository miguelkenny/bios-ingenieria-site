...
<div
  id="faq"
  class="lg:container lg:mx-auto lg:py-16 md:py-12 md:px-6 py-12 px-4"
>
  <h2
    class="text-center dark:text-white text-2xl sm:text-3xl lg:text-4xl leading-9 text-blue-900 font-bold uppercase"
  >
    Preguntas Frecuentes
  </h2>

  <div class="lg:w-8/12 w-full mx-auto mt-12 sm:mt-24">
    {#each faqs as faq, index}
      <div class="w-full px-4 sm:px-6 {faq.isOpen ? 'open-faq' : ''}">
        <div class="flex justify-between items-center w-full py-4 sm:py-6">
          <p
            class="flex items-center font-semibold text-lg sm:text-2xl lg:text-3xl text-gray-800"
          >
            {faq.question}
          </p>
          <button
          ...
          >
            <img
              class="border rounded-full p-1 {faq.isOpen ? 'rotate-180' : ''}"
        ...
        {#if faq.isOpen}
          <div class="mt-4 w-full">
            <p
              class="font-medium text-base sm:text-xl lg:text-2xl leading-7 sm:leading-8 text-gray-600 dark:text-gray-300"
            >
              {faq.answer}
            </p>
          </div>

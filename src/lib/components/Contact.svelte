...
>
  ...
  >
    ...
    <div class="w-full md:w-1/2 pr-0 md:pr-8">
      <h2 class="font-clashg text-md md:text-lg text-left mt-4 uppercase font-bold text-LightBlue">
        Contacto
      </h2>
    ...
    <div class="w-full md:w-max bg-white p-2 md:p-8 py-10 mr-0 md:mr-20 rounded-3xl shadow-lg">
      <form class="py-2">
        ...
        <div class="mb-4">
          <label
            for="email"
            class="font-clashg text-lg mt-4"
            >Email</label
          >
          <input
            type="email"
  ...
  <div class="flex flex-col gap-y-10 md:flex-row md:gap-x-20">
    <p class="font-clashg relative text-xl mt-2 font-medium text-left">+54 0264 154369135</p>
    <p class="font-clashg relative text-xl mt-2 font-medium text-left">biosing@hotmail.com.ar</p>
  </div>
</section>